...
<head>
<meta charset="utf-8"/>
<title>chruchEzi App Admin | CMS - About Us</title>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="./cms_about.php">CMS - About Us</a>
					</li>
				</ul>
                <!--
                ...
                <!-- BEGIN SAMPLE FORM PORTLET-->
					<div class="portlet box blue">
						...
						<div class="portlet-body form">
							<form role="form" method="post" enctype="multipart/form-data" action="handler_upload.php?ref=header_about">
								<div class="form-body">
            ...
            <div class="row">
                ...
                <!-- BEGIN SAMPLE FORM PORTLET-->
					<div class="portlet box blue">
                        ...
                        <?php
						//Get Info From DB
						$query_content = mysql_query("SELECT * FROM content WHERE ContentChurch = '$admin_church' && ContentType = 'about_content'");
						while ($row_content = mysql_fetch_array($query_content, MYSQL_ASSOC)) {
							$page_content = $row_content['ContentDescription'];
						}
						?>
							<form role="form" method="post" action="handler_content.php?ref=content_about">
								<div class="form-body">
									<div class="form-group">
									  <label for="txtContent">Add/Edit Page Content below.</label>
										<textarea class="wysihtml5" name="txtContent" rows="10" id="txtContent" data-provide="" data-width="600"><?php echo $page_content; ?></textarea>
										<p class="help-block">
											 Html tags allowed.
										</p>
									</div>
