...
<head>
<meta charset="utf-8"/>
<title>chruchEzi App Admin | CMS - Daily Devotional</title>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="./cms_devotional.php">CMS - Daily Devotional</a>
					</li>
				</ul>
                <!--
			...
			<h3 class="page-title">
			Daily Devotional <small>schedule and edit daily devotionals</small>
			</h3>
			<!-- END PAGE HEADER-->
			<div class="clearfix">
			</div>
            ...
            <div class="row"> 
                ...
                <iframe src="http://churchezi.com/clients/upperroom/devotional/wp-admin/" width="100%" height="100%" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div><!-- -->
            </div>
		</div>
	</div>
