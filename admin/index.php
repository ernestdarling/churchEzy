...
<head>
<meta charset="utf-8"/>
<title>chruchEzi App Admin | Dashboard</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<h3 class="page-title">
			Dashboard <small>app usage & statistics</small>
			</h3>
			<!-- END PAGE HEADER-->
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue-madison">
						...
						All Time <!--<i class="m-icon-swapright m-icon-white"></i>-->
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat red-intense">
						...
						<a class="more" href="javascript:;">
						This Month <!--<i class="m-icon-swapright m-icon-white"></i>-->
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-haze">
						...
						<a class="more" href="javascript:;">
						This Week <!--<i class="m-icon-swapright m-icon-white"></i>-->
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
