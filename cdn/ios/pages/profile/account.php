...
while ($row_member = mysql_fetch_array($query_member, MYSQL_ASSOC)) {
	...
	$member_password = $row_member['MemberPassword'];
}
?>
<!DOCTYPE HTML>
<html lang="en">
...
<div class="footer-menu footer-menu-fixed" align="center">
    ...
    <a href="account.php" class="active-menu"><i class="ion-ios-locked-outline"></i><em>Account</em></a>
        	...
        	<div class="contact-form no-bottom"> 
                  ...
                  <form action="php/account.php" method="post">
                          ...
                          <div class="formFieldWrap">
                              <label class="field-title contactNameField" for="txtMemberEmail">Email:<span></span></label>
                              <input type="text" name="txtMemberEmail" value="<?php echo $member_email; ?>" class="contactField requiredField" id="txtMemberEmail"/>
                          </div>
                          <div class="formFieldWrap">
                              <label class="field-title contactNameField" for="txtMemberPassword">Password:<span></span></label>
                              <input type="text" name="txtMemberPassword" value="<?php echo $member_password; ?>" class="contactField requiredField" id="txtMemberPassword"/>
                          </div>
                          <p></p>
                          <div class="formSubmitButtonErrorsWrap contactFormButton">
                              <input type="submit" class="buttonWrap button button-pink button-bold button-xs contactSubmitButton full-bottom" value="UPDATE INFO"/>
                          </div>
