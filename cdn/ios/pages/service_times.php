...
<div class="accordion">
<?php
$query_events = mysql_query("SELECT * FROM times WHERE TimeChurch = '$church_id' ORDER BY TimeID DESC");
while ($row_events = mysql_fetch_array($query_events, MYSQL_ASSOC)) {
	//Get Data
	$event_title = $row_events['TimeTitle'];
	$event_content = $row_events['TimeContent'];
	?>
